    ...
    >
      <van-pull-refresh v-model="isRefresh" @refresh="onRefresh">
        <van-list
          ...
          @load="onLoad"
        >
          <div style="width: 100%" v-if="preLiveList && preLiveList.length > 0">
            <div
              class="content-list"
              v-for="(item, index) in preLiveList"
              :key="index"
            >
              <div class="list-item" @click="Todetails(item)">
                <div class="item-top d-flex align-items-start">
                  <div
                    style="
                      position: relative;
                  ...
                  >
                    ...
                    <div class="progress-box">
                      <div v-if="item.progress != 100" class="one">
                        已学习{{ item.progress }}%
                      </div>
                      <div v-if="item.progress == 100" class="two">
                        已学完
                      </div>
                      <!-- <div
                        v-if="
                          item.courseType == 4 && !isComplete(item.progress)
                        "
                        class="one"
                      >
                        已学习{{ item.progress }}%
                      ...
                      <div
                        v-if="item.courseType == 4 && isComplete(item.progress)"
                        class="two"
                      >
                        已学完
                      </div> -->
                  ...
                  <div style="display: inline-block; vertical-align: top">
                    ...
                    <!--                      <div v-if="item.courseType != 4 && item.progress != 100">-->
                    <!--                        已学习{{ item.progress }}%-->
                    <!--                      </div>-->
                    <!--                      <div-->
                    <!--                        v-if="item.courseType != 4 && item.progress == 100"-->
                    <!--                        style="color: #2780f8"-->
                    <!--                      >-->
                    <!--                        已学完-->
                    <!--                      </div>-->
                ...
                >
                  ...
                  >
                  <!--<span v-else style="color: #969799">不限</span>-->
                </div>
              </div>
            </div>
          </div>
...
<script src="./task-learned.js"></script>
<style scoped>
