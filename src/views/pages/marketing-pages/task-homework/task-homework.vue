<template>
  <div>
    ...
    <!--    <testList v-show="flag === 1" @getDataFromL="totalNumber"></testList>-->
    <homeworkList
      :selectStatus="selectStatus"
      @getDataFromC="workTotal"
    ></homeworkList>
    <!--    <pkWallList v-show="flag === 3"></pkWallList>-->
  </div>
</template>
<script>
import Vue from "vue";
import { Toast, NavBar, Cell, CellGroup, List, PullRefresh } from "vant";
import homeworkList from "@/views/pages/marketing-pages/task-homework/homework-list.vue";
