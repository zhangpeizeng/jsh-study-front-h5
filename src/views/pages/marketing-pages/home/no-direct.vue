<template>
  <div style="background-color: white;height: 100vh;">
    ...
    <div style="width: 100%;text-align: center;padding-top: 40px;">
      ...
      <div
        style="width: 100%;text-align: center;font-size: 16px;color: #646566;padding: 15px 30px 0 30px;"
      >
        <div>
          您登录的是直销员端，身份不匹配，无法登录，如有问题，请联系<span>{{
            phone
          }}</span>
        </div>
      </div>
...
export default {
  ...
  created() {
    this.studyTerminalCode = this.$route.query.studyTerminalCode; // 登录终端
    this.getPhone();
  }
};
</script>
